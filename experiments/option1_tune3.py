...
def run(D,state,L,cells,combine,steps,tag=''):
...
print('=== T2c: D64 L2 256c gate-blend ===')
run(64,8,2,256,'gate',2500,'256c_gate')
print('=== T3a: D64 L2 128c cat LONGER 4000 steps ===')
run(64,8,2,128,'cat',4000,'128c_long')
print('=== T3b: D64 L2 256c gate LONGER 4000 steps ===')
run(64,8,2,256,'gate',4000,'256c_gate_long')
