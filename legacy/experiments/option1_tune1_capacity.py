...
# Baseline anchor: D64 L2 32cells cat
print('=== anchor: D64 L2 32c cat (reproduce 51%) ===')
run(64,8,2,32,'cat',2500,'anchor')
print('=== T1a: D64 L2 64c cat ===')
run(64,8,2,64,'cat',2500,'64c')
print('=== T1b: D64 L2 128c cat ===')
run(64,8,2,128,'cat',2500,'128c')
print('=== T1c: D64 L2 256c cat ===')
run(64,8,2,256,'cat',2500,'256c')
print('=== T1d: D96 L2 64c cat ===')
run(96,8,2,64,'cat',2500,'d96_64c')
